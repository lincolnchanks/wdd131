...
function recipesTemplate(recipe) {
    // Returns the template literal for a recipe card based on the selected recipe object.
    return `<div class="recipe-card">
                <img src="${recipe.image}" alt="Apple Crisp Image">
                <div class="card-desc">
                    <p class="type-tag">Dessert</p>
                    <h2>Apple Crisp</h2>
                    <span
                    class="rating"
                    role="img"
                    ...
                    <p class="hidden">This apple crisp recipe is a simple yet delicious fall dessert that's great served warm with vanilla ice cream.</p>
                </div>
            </div>`
}